export default function Page() {
  return (
    <div className="col-span-full col-start-1 row-span-full row-start-1 flex min-h-screen flex-col justify-center md:col-span-6 md:col-start-2 lg:col-span-6 lg:col-start-4">
